  ...
  render() {
    return (
      ...
      >
        ...
        >{this.props.title?this.props.title:'支付宝'}</Text>
      </View>
        <TouchableOpacity
          style={{width: 310,height: 50,marginTop:20,alignSelf:'center',backgroundColor: '#90C76D',justifyContent: 'space-around',borderWidth: 1 / PixelRatio.get(),borderColor:'#90C76D',marginBottom: 5}}
